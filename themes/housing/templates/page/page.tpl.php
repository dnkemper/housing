            ...
            <?php if ($title): ?>
              <h1 id="page-title" class="page-title">
                ...
                <?php if (isset($hashtag)): ?>
                  <span class="label label-primary"><?php print $hashtag; ?></span>
                <?php endif; ?>
                <?php if (isset($experiences)): ?>
                  <?php foreach ($experiences as $experience): ?>
                    <span class="label label-warning"><?php print $experience; ?></span>
                  <?php endforeach; ?>
                <?php endif; ?>
                <?php if (isset($interests)): ?>
                  <?php foreach ($interests as $interest): ?>
                    <span class="label label-danger"><?php print $interest; ?></span>
                  <?php endforeach; ?>
                <?php endif; ?>
              </h1>
            <?php endif; ?>
